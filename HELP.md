...
* The original package name 'project-management-api.project-management-api' is invalid and this project uses 'project_management_api.project_management_api' instead.
